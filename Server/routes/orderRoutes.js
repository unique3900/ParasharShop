...
passport.authenticate('jwt'),updateRatingStatusController).get('/sellers/:id',passport.authenticate('jwt') , fetchSellerOrders).get('/sellers/total-orders/:id',passport.authenticate('jwt'), fetchTotalOrers).get('/braintree/token',passport.authenticate('jwt'),braintreeTokenController).post('/braintree/payment',passport.authenticate('jwt'),braintreePaymentController)
